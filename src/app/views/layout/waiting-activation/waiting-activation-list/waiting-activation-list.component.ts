...
@Component({
  selector: 'app-waiting-activation-list',
  templateUrl: './waiting-activation-list.component.html',
  styleUrls: ['./waiting-activation-list.component.scss']
})
export class WaitingActivationListComponent implements OnInit {
...
// personalImg: any;
  ...
  this._spinnerService.requestStarted();
    this._userService.getWaitingForActivation().subscribe(res => {
