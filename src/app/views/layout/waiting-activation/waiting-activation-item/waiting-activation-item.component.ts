...
@Component({
  selector: 'app-waiting-activation-item',
  templateUrl: './waiting-activation-item.component.html',
  styleUrls: ['./waiting-activation-item.component.scss']
})
export class WaitingActivationItemComponent implements OnInit {
