...
@Component({
  selector: 'app-active-clients-item',
  templateUrl: './active-clients-item.component.html',
  styleUrls: ['./active-clients-item.component.scss']
})
export class ActiveClientsItemComponent implements OnInit {
