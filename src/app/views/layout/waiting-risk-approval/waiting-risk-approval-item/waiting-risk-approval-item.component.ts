...
@Component({
  selector: 'app-waiting-risk-approval-item',
  templateUrl: './waiting-risk-approval-item.component.html',
  styleUrls: ['./waiting-risk-approval-item.component.scss']
})
export class WaitingRiskApprovalItemComponent implements OnInit {
